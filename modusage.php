...
echo $OUTPUT->header();
echo $OUTPUT->heading(
  get_string('lb_course', 'report_questionstats') . get_string('pluginname', 'mod_' . $result->name)
);

if ($category == REPORT_QUESTIONSTATS_ALL_CTYPE) {
...
$table->head = array(
  get_string('lb_course', 'report_questionstats')
);
