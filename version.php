...
$plugin->version   = 2020120911;         // The current plugin version (Date: YYYYMMDDXX)
...
$plugin->release  = 'v1.2';         // Requires this Moodle version (see https://docs.moodle.org/dev/Releases)